...
const DetailMoviesBody = ({ movieData }: MovieDetail) => {
  return (
                      ...
                      <section className="pl-[40px] flex flex-wrap items-start content-center box-border">
                        ...
                        <div className="w-full mb-[24px] flex flex-wrap">
                          ...
                          <div className="flex">
                            ...
                            <span className="pf-[20px] relative top-0 left-0 text-[14px] max-w-[414px] leading-tight">
                              ...
                              ,&nbsp;
                              <a href="#" className="hover:text-[#ffffffb3]">
                                {movieData.genres[1].name}
                              </a>
                              ,&nbsp;
                              <a href="#" className="hover:text-[#ffffffb3]">
                                {movieData.genres[2].name}
                              </a>
                              ,&nbsp;
                              <a href="#" className="hover:text-[#ffffffb3]">
                                Phim Giả Tượng
                        ...
                        <ul className="flex h-[68px] w-full mb-[20px] items-center justify-start">
                          ...
                          <li className="mr-0">
                            ...
                            >
                              ...
                              <span className="text-[14px]">Play Trailer</span>
                            </a>
                          </li>
                        </ul>
                        ...
                        <div className="w-full">
                          ...
                          <ol className="mt-[20px] flex justify-start flex-wrap relative top-0 left-0">
                            {/* profile */}
                            <li className="h-auto - mb-0 w-[33%] basis-[33%] text-left pr-[20px] box-border min-w-[14px] ">
                      ...
                      <section className="w-full block pb-[30px]">
                        ...
                        <div className="relative top-0 left-0">
                          <ol className="overflow-x-scroll overflow-y-hidden ml-[-10px] mt-[-10px] pb-[10px] flex relative top-0 left-0">
                            <li className="my-[10px] mr-[4px] ml-[10px] pb-[10px] overflow-hidden border-[1px] border-solid border-[#e3e3e3] min-w-[140px] w-[140px] bg-white shadow-[0_2px_8px_rgba(0,0,0,0.1)]">
                              {/* img */}
                              <a
                                href="#"
                                className="mix-w-[138px] w-[138px] h-[175px] block "
                              >
                                <img
                                  src="https://www.themoviedb.org/t/p/w138_and_h175_face/liV9OXUeo7T19hhjFlqTELtETnW.jpg"
                                  alt="Leah Lewis"
                                />
                              </a>
                              {/* name */}
                              <p className="pt-[10px] px-[10px] text-[14px] overflow-hidden text-ellipsis">
                                <a
                                  href="#"
                              ...
                              {/* detail */}
                              <p className="px-[10px] text-[12.3px] overflow-hidden text-ellipsis">
                                Ember Lumen (voice)
                              </p>
                            </li>
                        ...
                        <div>
                          ...
                          <div className="relative top-0 left-0">
                            <div className="overflow-y-hidden overflow-x-scroll whitespace-nowrap pb-[10px]">
                              {/* card */}
                              <div className="inline-block w-[250px] mr-[15px]">
                                <div className="w-[250px] h-[141px] overflow-hidden">
                                  <a href="#" className={`${styles["card"]}`}>
                                    <img
                                      src="https://www.themoviedb.org/t/p/w250_and_h141_face/sC8YOcp8tOQ5s9RgGsZnLDGTZSa.jpg"
                                      alt="Điệp Viên Stone"
                                ...
                                <div className="flex justify-between mt-[4px] text-black">
                                  <a
                                    href="#"
                                    className="text-[14px] pr-[20px] "
                                  >
                                    <h5>Điệp Viên Stone</h5>
                                  </a>
                        ...
                        <div className="w-full">
                          ...
                          <section className="w-full border-b-[1px] border-solid border-[#d7d7d7] mb-[30px]">
                            ...
                            <ul className="pb-[30px] w-full flex flex-wrap justify-start">
                              <li className="mr-[5px] mb-[10px] leading-6 text-[12.6px] ">
                                <a
                                  href="#"
