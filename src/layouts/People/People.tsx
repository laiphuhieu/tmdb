                ...
                <div className="max-w-[1400px] px-[40px] py-[30px] w-full flex items-start">
                  ...
                  <div className="min-w-[300px] w-[300px] justify-end">
                    <section className="flex flex-nowrap ">
                      <div className="block min-w-[300px] w-[300px] h-[450px] relative top-0 left-0">
                        <div className="rounded-[8px] overflow-hidden w-full h-full min-h-full ">
                          <Image
                            className="h-[450px] bg-gray"
                            alt={peopleData.name}
                            src={`https://www.themoviedb.org/t/p/w300_and_h450_bestv2/${peopleData.profile_path}`}
                            fallback="https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-4-user-grey-d8fe957375e70239d6abdd549fd7568c89281b2179b5f4470e2e12895792dfa5.svg"
                          />
                        </div>
                      </div>
                    </section>
                        ...
                        <section>
                          ...
                          <div className="mb-[20px] text-[14px] text-black flex flex-col">
                            ...
                            {peopleData && peopleData.also_known_as.length ? (
                              peopleData.also_known_as?.map((res, index) => {
                                return <ul key={index}>{res}</ul>;
                              })
                            ) : (
                              <>-</>
                            )}
                  ...
                  <div>
                    <div className="max-w-[920px] w-[calc(100vw-80px-300px)] pl-[30px] flex bg-white flex-wrap">
                      ...
                      <section className="w-full mt-[30px]">
                        <div className="w-full">
                          <h3 className="text-[18.2px] mb-[8px]">Known For</h3>
                                        ...
                                        <div className="w-[130px] h-[195px]">
                                          <a href={`/movie/${res.id}`}>
                                            <Image
                                              ...
                                              fallback="https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-38-picture-grey-c2ebdbb057f2a7614185931650f8cee23fa137b93812ccb132b9df511df1cfac.svg"
                                            />
                                          </a>
                                        </div>
                                        <p>
                                          <a
                                            href={`/movie/${res.id}`}
                                            className="pt-[4px] w-full h-full text-[12.6px] text-center inline-block"
                                          >
                                            {res.title || res.name}
                                          </a>
                                        </p>
                                              ...
                                              <tbody className="bg-white ">
                                                <tr className="border-b-[1px] border-solid border-[#e3e3e3] ">
                                                  ...
                                                  <td className="py-[8px] px-[16px] align-text-top">
                                                    <Link
                                                      to={`/movie/${res.id}`}
                                                      className="text-black first-letter:"
                                                    >
                                                      {res.name || res.title}
                                                    </Link>
